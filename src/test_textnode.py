...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq_false(self):
        ...
        node2 = TextNode(
            "This is a text node", text_type_bold, "https://www.google.com"
        )
    ...
    def test_eq_false2(self):
        node = TextNode("This is a text node", text_type_text, "https://www.google.com")
        node2 = TextNode(
            "This is a text node2", text_type_text, "https://www.google.com"
        )
        self.assertNotEqual(node, node2)
    ...
    def test_repr(self):
        node = TextNode("This is a text node", text_type_text, "https://www.google.com")
        self.assertEqual(
            "TextNode(This is a text node, text, https://www.google.com)",
            repr(node),
        )
    ...
    def test_convert_bold(self):
        node = TextNode("This is a bold text node", "bold", None)
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "b")
        self.assertEqual(html_node.value, "This is a bold text node")

    def test_convert_italic(self):
        node = TextNode("This is an italic text node", "italic", None)
        html_node = text_node_to_html_node(node)
    ...
    #     self.assertEqual(text_node_to_html_node(node_1), node_2)

    # def test_convert_link(self):
    #     node_1 = TextNode("This is a link text node", "link", "https://www.google.com")
    #     node_2 = LeafNode(
    #         "a", "This is a link text node", None, {"href": "https://www.google.com"}
    #     )
    #     self.assertEqual(text_node_to_html_node(node_1), node_2)

    # def test_convert_image(self):
    #     node_1 = TextNode(
    #         "This is an image text node", "image", "https://www.google.com"
    #     )
    #     node_2 = LeafNode(
    #         "img",
    #         "",
    ...
    #     node = TextNode(
    #         "This is text with a **bold** word and **another**. More text after.",
    #         text_type_text,
    #     )
    #     new_nodes = split_nodes_delimiter([node], "**", text_type_bold)
    #     self.assertEqual(
